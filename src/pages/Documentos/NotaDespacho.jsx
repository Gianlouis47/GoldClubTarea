...
export default function NotaDespacho() {
  ...
  const [form, setForm] = useState({
    numNota: '408542', fechaEmision: hoy,
    direccion: 'C/ 27 de febrero, Tenares, centro del pueblo',
    descripcion: 'Tequila Don Julio 70 6x75 Cl',
    codigo: 'BB076689638', numOrden: '0893799',
    cantidad: '54', receptor: 'Carlos De Jesús', encargado: 'Camilo Alonso',
  })
      ...
      <div className="main-content">
        <div className="two-col">
          <div className="card card-gold">
            ...
            {[
              ['Num. nota de despacho:', 'numNota', 'text'],
              ['Fecha de emisión:', 'fechaEmision', 'text'],
              ['Dirección de entrega:', 'direccion', 'text'],
              ['Descripción del producto:', 'descripcion', 'text'],
              ['Código del producto:', 'codigo', 'text'],
              ['Num. de orden:', 'numOrden', 'text'],
              ['Cantidad despachada:', 'cantidad', 'number'],
            ].map(([label, key, type]) => (
            ...
            <div className="form-group"><label>Nombre de quien recibe:</label><input className="form-control" type="text" value={form.receptor} onChange={set('receptor')}/></div>
            <div className="form-group"><label>Encargado de despacho:</label><input className="form-control" type="text" value={form.encargado} onChange={set('encargado')}/></div>
